...
// This is our socket connection which is used to stream the logs in frontend side.
...
export default function Home() {
  ...
  // used to check the URL is valid or not and also to show the error message.
